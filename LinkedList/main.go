...
func (linkedList *LinkedList) AddToHead(property int) {
	...
	node.nextNode = nil
   pretty.Println("linkedList1",linkedList)
	if linkedList.headNode != nil {
		fmt.Println("linkedList.headNode1",linkedList.headNode)
		//fmt.Println(node.property)
		node.nextNode = linkedList.headNode
	}
	pretty.Println("linkedList2",linkedList)
	fmt.Println("linkedList.headNode2",node)
